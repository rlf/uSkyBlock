 ...
 * the unlock event is cancelled from us! The cancelling plugin should send a message to the initializer
 * if feedback is expected.
 * @since 2.8.4
 */
public class IslandUnlockEvent extends CancellableIslandEvent {
    ...
    /**
     * Gets the {@link OfflinePlayer} initializing the unlock event, if available.
